...
class QualificationModel extends CI_Model
{
    ...
    {
        $rowCount = 0;
        $query = "INSERT INTO `qualification_master`(`name`,`ordering`,`is_add_update`,`status`) VALUES ";
        $header = false;
        $firstRow = true;
        $temp = 0;
