...
class EmploymentTypeMasterModel extends CI_Model
{
    protected $table = "employement_type_master";
    var $selected_col = "id,name,name as label,id as value,status,ordering";
