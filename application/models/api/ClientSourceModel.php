...
class ClientSourceModel extends CI_Model
{
    protected $table = "client_source_master";
    ...
    {
        $rowCount = 0;
        $query = "INSERT INTO `client_source_master`(`name`,`ordering`,`is_add_update`,`status`) VALUES ";
        $header = false;
        $firstRow = true;
        $temp = 0;
