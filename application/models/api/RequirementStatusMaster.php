...
class RequirementStatusMaster extends CI_Model
{
    protected $table = "requirement_status_master";
    ...
    {
        $rowCount = 0;
        $query = "INSERT INTO `requirement_status_master`(`name`,`ordering`,`is_add_update`,`status`) VALUES ";
        $header = false;
        $firstRow = true;
        $temp = 0;
