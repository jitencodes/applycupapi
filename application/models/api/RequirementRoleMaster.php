...
class RequirementRoleMaster extends CI_Model
{
    protected $table = "requirement_role_master";
    ...
    {
        $rowCount = 0;
        $query = "INSERT INTO `requirement_role_master`(`name`,`ordering`,`is_add_update`,`status`) VALUES ";
        $header = false;
        $firstRow = true;
        $temp = 0;
            ...
            if (!$header){
                ...
                if($firstRow){
                    ...
                    if ($temp == 500) {
                        ...
                        $query .= 'ordering= VALUES(ordering),';
